  ...
  return (
    <header className="flex fixed h-[125px] top-0 left-0 w-full z-[100]">
      <div className="w-full">
          ...
          <div className="md:flex items-center gap-4">
            ...
            <div className="flex max-sm:justify-center items-center gap-2">
              ...
              <FontAwesomeIcon
                ...
                className="w-[12px] h-[16px]"
              />
              <FontAwesomeIcon icon={faTwitter} className="w-[12px] h-[16px]" />
              <FontAwesomeIcon
                icon={faInstagram}
                className="w-[12px] h-[16px]"
              />
        ...
        <div className="flex justify-between items-center md:px-[124px] max-sm:px-4 py-[32px] max-sm:bg-black text-white">
          <div>
            <img
          ...
          <div className="flex gap-4">
            ...
            <div className="flex items-center md:gap-4 max-sm:gap-2">
              ...
              <div className="border-2 border-white px-2">
