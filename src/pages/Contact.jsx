        ...
        <div className='md:flex md:px-[145px] px-12 py-[80px]'>
          <div className='md:w-1/2'>
            <div className='flex gap-4 py-8'>
              <img src="https://i0.wp.com/tihalt.com/wp-content/uploads/2020/02/230643_preview-e1580738879355.png?fit=26%2C27&amp;ssl=1" width="26" height="27" alt="phone" />
              <p className='text-[#383838] text-[26px] font-semibold'>Phone</p>
            </div>
            <p className='text-[16px]'><span className='text-[#666666] font-semibold'>Phone</span> : <a href="tel:+919611223984" className='hover:text-black hover:underline text-[#EFB025] '>+91 96 1122 3984</a></p>
          </div>
          <div className='md:w-1/2'>
          <div className='flex gap-4 py-8'>
              <img src="https://i0.wp.com/tihalt.com/wp-content/uploads/2020/02/unnamed-e1580739201215.png?fit=42%2C27&ssl=1" width="42" height="27" alt="email" />
              <p className='text-[#383838] text-[26px] font-semibold'>Email</p>
            </div>
            
            <p className='text-[#EFB025] text-[16px] hover:text-black hover:underline py-1'><a href="email:info@tihalt.com">info@tihalt.com</a></p>
            <p className='text-[#EFB025] text-[16px] hover:text-black hover:underline py-1'><a href="email:support@tihalt.com">support@tihalt.com</a></p>
          </div>
          </div>
